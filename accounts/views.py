...
from .serializers import LoginSerializer, RegistrationSerializer, RestorePasswordSerializer, RestorePasswordCompleteSerializer, ChangePasswordSerializer
...
class ChangePasswordView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            serializer.set_new_password()
            return Response('Пароль умпешно обновлен')
